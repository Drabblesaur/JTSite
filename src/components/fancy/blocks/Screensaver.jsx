...
/**
 * Screensaver — from fancycomponents.dev, ported to JS.
 * Bounces its child around the referenced container (DVD-logo style).
 */
export default function Screensaver({
  ...
  }, [containerDimensions, elementDimensions, startPosition]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <motion.div
      ref={elementRef}
      style={{ position: 'absolute', top: 0, left: 0, x, y, willChange: 'transform' }}
